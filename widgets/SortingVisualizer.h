#ifndef ALGOVISUALIZER_WIDGETS_SORTINGVISUALIZER_H
#define ALGOVISUALIZER_WIDGETS_SORTINGVISUALIZER_H

/**
 * @file SortingVisualizer.h
 * @brief Declares the SortingVisualizer class used for visualizing sorting algorithms.
 *
 ...
 * @brief Provides interactive sorting algorithm visualization with step-by-step or autoplay execution.
 *
 * This widget:
 * - Displays array as bars using ArrayVisualizer.
 * - Supports Bubble, Selection, Insertion, Merge, and Quick Sort.
 * - Generates random arrays, parses custom input, and manages animation speed.
 * - Enqueues sorting “steps” to show each comparison, swap, and operation.
 */
...
#endif  // ALGOVISUALIZER_WIDGETS_SORTINGVISUALIZER_H
