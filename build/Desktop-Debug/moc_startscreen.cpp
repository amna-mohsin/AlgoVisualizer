...
QT_MOC_LITERAL(3, 26, 19) // "on_btnStart_clicked"

    },
    "StartScreen\0startClicked\0\0on_btnStart_clicked"
};
...
void StartScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartScreen::startClicked)) {
                *result = 0;
                return;
            }
        }
